...
class ProductFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $produit1->setShortDescription('Fabriqué en France · Ingrédients 100% naturels · Sans parabène · Non testé sur les animaux.');
        ...
        $produit1->setPicture('/public/img/produits/Image shot tropical.png');
        ...
        $produit2->setPicture('/public/img/produits/Image bougie.png');
        ...
        $produit3->setPicture('/public/img/produits/Image brosse a dent.png');
        ...
        $produit4->setPicture('/public/img/produits/Image deodorant bio.png');
        ...
        $produit5->setPicture('/public/img/produits/Image disques.png');
        ...
        $produit6->setPicture('/public/img/produits/Image gourde.png');
        ...
        $produit7->setPicture('/public/img/produits/Image kit en bois.png');
        ...
        $produit8->setPicture('/public/img/produits/Image kit hygiene.png');
        ...
        $produit9->setPicture('/public/img/produits/Image savon bio.png');
